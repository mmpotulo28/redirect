    ...
    <div className="flex flex-col gap-16 pb-8">
      ...
      <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-20 text-center">
        <div className="inline-block max-w-3xl justify-center">
          ...
          <h1 className={title({ size: "lg" })}>with Precision & Insight.</h1>
          <div
            className={subtitle({
              class: "mt-4 text-default-500 max-w-xl mx-auto",
            })}
          >
            Create custom short links, track detailed analytics, and manage your
            traffic with our advanced URL redirection platform.
          </div>
        </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
        <Card className="bg-content1/50 backdrop-blur-lg border-none shadow-md">
          ...
          <CardBody>
            <p className="text-small text-default-500">
              Track clicks, geographic location, device types, and operating
        ...
        <Card className="bg-content1/50 backdrop-blur-lg border-none shadow-md">
          ...
          <CardBody>
            <p className="text-small text-default-500">
              Create memorable, branded links that build trust and increase
              click-through rates.
            </p>
          </CardBody>
        </Card>
        ...
        <Card className="bg-content1/50 backdrop-blur-lg border-none shadow-md">
          ...
          <CardBody>
            <p className="text-small text-default-500">
              Seamless interstitial pages that inform users before redirecting,
              enhancing UX.
            </p>
          </CardBody>
        </Card>
        ...
        <Card className="bg-content1/50 backdrop-blur-lg border-none shadow-md">
          ...
          <CardBody>
            <p className="text-small text-default-500">
              Built with modern tech stack ensuring 99.9% uptime and secure link
              management.
            </p>
          </CardBody>
        </Card>
      ...
      <section className="flex flex-col items-center gap-8 py-12 bg-content1/30 rounded-3xl mx-4">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center w-full max-w-4xl px-4">
          <div className="flex flex-col items-center text-center gap-2 flex-1">
            <div className="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center text-xl font-bold mb-2">
              1
            </div>
          ...
          <div className="flex flex-col items-center text-center gap-2 flex-1">
            ...
            <p className="text-default-500">
              Add a custom alias and description.
            </p>
          </div>
          <div className="hidden md:block w-24 h-0.5 bg-default-200" />
          <div className="flex flex-col items-center text-center gap-2 flex-1">
            ...
            <p className="text-default-500">
              Share your link and monitor performance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col items-center justify-center gap-6 py-16 text-center">
        ...
        <p className="text-default-500 max-w-lg">
          Join thousands of users who trust LinkFlow for their link management
          needs.
        </p>
        <Button
          as={Link}
