 ...
 return (
  <div className="max-w-6xl mx-auto pb-10">
   <div className="flex flex-col gap-2 mb-8">
    <Link href="/dashboard" className="text-sm text-default-500 mb-2">
     ← Back to Dashboard
    </Link>
    <h1 className={title()}>{redirect.shortCode}</h1>
    <div className="flex flex-col sm:flex-row gap-4 text-default-500">
     <Link isExternal href={redirect.targetUrl} className="text-primary">
      {redirect.targetUrl}
     </Link>
     <span>•</span>
   ...
   <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
    <Card>
     <CardBody className="text-center py-8">
      <div className="text-4xl font-bold text-primary">{redirect._count.clicks}</div>
